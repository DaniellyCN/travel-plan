      ...
      <table class="table table-striped" aria-describedby="travelPlans">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('myappApp.travelPlan.name')">Name</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.startDate')">Start Date</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.endDate')">End Date</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.airlineCompanyName')">Airline Company Name</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.airlineTicketNumber')">Airline Ticket Number</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.hotelName')">Hotel Name</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.hotelBookingNumber')">Hotel Booking Number</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.carCompanyName')">Car Company Name</span></th>
            <th scope="row"><span v-text="$t('myappApp.travelPlan.carBookingNumber')">Car Booking Number</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
